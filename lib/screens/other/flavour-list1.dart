...
class FlavourPage extends StatefulWidget {
  ...
  final String locale, shippingType;
  final int flavourSelectable, minimumOrderAmount;
            ...
            try {
              ...
              await Common.getProducts().then((productsList) {
                ...
                Common.addProduct(productsList).then((value) {
                  Common.getCart().then((value) {
                    Map<String, dynamic> cartItems = {};
                    cartItems = value;
                    cartItems['productDetails'] = productsList;
                    Common.setCart(cartItems);
                  });
                  Toast.show(
                      MyLocalizations.of(context).producthasbeenaddedtocart,
                      context,
